...
kubectl port-forward --address 0.0.0.0 svc/gitlab-webservice-default -n gitlab 8686:8181  | kubectl port-forward --address 0.0.0.0 svc/argocd-server -n argocd 8080:443
echo -e "${GREEN} ====================================================${ENDCOLOR}"
